...
class BinanceFuturesClient:
    ...
    def _make_request(self, method: str, endpoint: str, data: typing.Dict):
        ...
        if response.status_code == 200:
            ...
            logger.error("Error while making %s requests to %s: %s (ERROR STATUS CODE: %s)", method, endpoint, response.json(), response.status_code)
            return None
    ...
    def get_hisorical_candles(self, contract: Contract, interval: str) -> typing.List[Candle]:
        data = dict()
    ...
    def _on_close(self, ws):
        logger.warning("Binance connection Close")
